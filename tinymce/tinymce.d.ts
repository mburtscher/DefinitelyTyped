    ...
    */
    ...
    export module dom {
        ...
        export interface DOMUtils {
            constructor(d: Document, s: Object): DOMUtils;
            add(parentElm: string, name: string, attrs?: Object, html?: string): Element;
            add(parentElm: string, name: Element, attrs?: Object, html?: string): Element;
            add(parentElm: string[], name: string, attrs?: Object, html?: string): Element[];
            add(parentElm: string[], name: Element, attrs?: Object, html?: string): Element[];
            add(parentElm: Element, name: string, attrs?: Object, html?: string): Element;
            add(parentElm: Element, name: Element, attrs?: Object, html?: string): Element;
            add(parentElm: Element[], name: string, attrs?: Object, html?: string): Element[];
            add(parentElm: Element[], name: Element, attrs?: Object, html?: string): Element[];
            addClass(elm: string, cls: string): string;
            addClass(elm: string[], cls: string): string[];
            addClass(elm: Element, cls: string): string;
            addClass(elm: Element[], cls: string): string[];
            addStyle(cssText: string): void;
            bind(target: Element, name: string, func: () => void, scope?: Object): () => void;
            bind(target: Element[], name: string, func: () => void, scope?: Object): () => void;
            bind(target: Document, name: string, func: () => void, scope?: Object): () => void;
            bind(target: Document[], name: string, func: () => void, scope?: Object): () => void;
            bind(target: string[], name: string, func: () => void, scope?: Object): () => void;
            ...
            destroy(): void;
            encode(test: string): string;
            findCommonAncestor(a: Element, b: Element): Element;
            fire(target: Node, name: string, evt: Object): Event;
            fire(target: Document, name: string, evt: Object): Event;
            fire(target: Window, name: string, evt: Object): Event;
            get(n: string): Element;
            get(n: Element): Element;
            getAttrib(elm: string, name: string, defaultVal?: string): string;
            getAttrib(elm: Element, name: string, defaultVal?: string): string;
            getAttribs(elm: string): NodeList;
            getAttribs(elm: Element): NodeList;
            getNext(node: Node, selector: string): Node;
            getNext(node: Node, selector: () => boolean): Node;
            getOuterHTML(elm: string): string;
            getOuterHTML(elm: Element): string;
            getParent(node: string, selector: string, root?: Node): Node;
            getParent(node: string, selector: () => boolean, root?: Node): Node;
            getParent(node: Element, selector: string, root?: Node): Node;
            getParent(node: Element, selector: () => boolean, root?: Node): Node;
            getParents(node: string, selector: string, root?: Node): Node[];
            getParents(node: string, selector: () => boolean, root?: Node): Node[];
            getParents(node: Element, selector: string, root?: Node): Node[];
            getParents(node: Element, selector: () => boolean, root?: Node): Node[];
            getPos(elm: string, rootElm?: Element): { x: number; y: number };
            getPos(elm: Element, rootElm?: Element): { x: number; y: number };
            getPrev(node: Node, selector: string): Node;
            getPrev(node: Node, selector: () => boolean): Node;
            getRect(elm: string): { x: number; y: number; w: number; h: number };
            getRect(elm: Element): { x: number; y: number; w: number; h: number };
            getRoot(): Element;
            getSize(elm: string): { w: number; h: number };
            getSize(elm: Element): { w: number; h: number };
            getStyle(elm: string, name: string, computed: boolean): string;
            getStyle(elm: Element, name: string, computed: boolean): string;
            getViewPort(win?: Window): { x: number; y: number; w: number; h: number };
            hasClass(n: string, c: string): boolean;
            hasClass(n: Element, c: string): boolean;
            hide(e: string): void;
            hide(e: string[]): void;
            hide(e: Element): void;
            hide(e: Element[]): void;
            insertAfter(node: Element, reference_node: string): Element;
            insertAfter(node: Element, reference_node: Element): Element;
            insertAfter(node: Element, reference_node: Element[]): Element[];
            is(elm: Node, selector: string): boolean;
            is(elm: NodeList, selector: string): boolean;
            isBlock(node: string): boolean;
            isBlock(node: Node): boolean;
            isEmpty(node: string, elements?: Object): boolean;
            isEmpty(node: Node, elements?: Object): boolean;
            isHidden(e: string): boolean;
            isHidden(e: Element): boolean;
            loadCSS(u: string): void;
            nodeIndex(node: Node, normalized?: boolean): number;
            parseStyle(cssText: string): Object;
            remove(node: string, keepChildren?: boolean): Element;
            remove(node: Element, keepChildren?: boolean): Element;
            remove(node: string[], keepChildren?: boolean): Element[];
            remove(node: Element[], keepChildren?: boolean): Element[];
            removeAllAttribs(e: Element): void;
            removeAllAttribs(e: string): void;
            removeAllAttribs(e: Element[]): void;
            removeAllAttribs(e: string[]): void;
            removeClass(elm: string, cls: string): string;
            removeClass(elm: Element, cls: string): string;
            removeClass(elm: string[], cls: string): string[];
            removeClass(elm: Element[], cls: string): string[];
            rename(elm: Element, name: string): Element;
            replace(newElm: Element, oldElm: string, k?: boolean): void;
            replace(newElm: Element, oldElm: string[], k?: boolean): void;
            replace(newElm: Element, oldElm: Element, k?: boolean): void;
            replace(newElm: Element, oldElm: Element[], k?: boolean): void;
            run(Element: string, f: () => void, s?: Object): Object;
            run(Element: Element, f: () => void, s?: Object): Object;
            run(Element: string[], f: () => void, s?: Object): Object[];
            run(Element: Element[], f: () => void, s?: Object): Object[];
            select(selector: string, scope?: Object): Element[];
            serializeStyle(styles: Object, name?: string): string;
            setAttrib(e: string, n: string, v: string): void;
            setAttrib(e: string[], n: string, v: string): void;
            setAttrib(e: Element, n: string, v: string): void;
            setAttrib(e: Element[], n: string, v: string): void;
            setAttribs(elm: string, attrs: Object): void;
            setAttribs(elm: string[], attrs: Object): void;
            setAttribs(elm: Element, attrs: Object): void;
            setAttribs(elm: Element[], attrs: Object): void;
            setHTML(elm: string, h: string): void;
            setHTML(elm: string[], h: string): void;
            setHTML(elm: Element, h: string): void;
            setHTML(elm: Element[], h: string): void;
            setOuterHTML(elm: string, h: string, doc?: Document): void;
            setOuterHTML(elm: string[], h: string, doc?: Document): void;
            setOuterHTML(elm: Element, h: string, doc?: Document): void;
            setOuterHTML(elm: Element[], h: string, doc?: Document): void;
            setStyle(n: string, na: string, v: string): void;
            setStyle(n: string[], na: string, v: string): void;
            setStyle(n: Element, na: string, v: string): void;
            setStyle(n: Element[], na: string, v: string): void;
            setStyles(e: string, o: Object): void;
            setStyles(e: string[], o: Object): void;
            setStyles(e: Element, o: Object): void;
            setStyles(e: Element[], o: Object): void;
            show(elm: string): void;
            show(elm: string[]): void;
            show(elm: Element): void;
            show(elm: Element[]): void;
            split(parentElm: Element, splitElm: Element, replacementElm?: Element): Element;
            toHex(rgbVal: string): string;
            toggleClass(elm: Element, cls: string, state?: boolean): void;
            unbind(target: Element, name: string, func: () => void): boolean;
            unbind(target: Element[], name: string, func: () => void): boolean[];
            unbind(target: Document, name: string, func: () => void): boolean;
            unbind(target: Document[], name: string, func: () => void): boolean[];
            unbind(target: Window, name: string, func: () => void): boolean;
            unbind(target: Window[], name: string, func: () => void): boolean[];
            uniqueId(prefix?: string): string;
        }
        interface DOMUtils_Static {
            new (): DOMUtils;
            DOM: DOMUtils;
        }
        export var DOMUtils: DOMUtils_Static;
